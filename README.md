...
The programs create Grid Cards, Force cards and Moment cards in the from of .txt files from excel sheets.<br/>
These .txt files can be used as an input to Nastran for load calculation.<br/>
